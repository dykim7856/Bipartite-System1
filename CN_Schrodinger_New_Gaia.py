import numpy as np #numerical computation (NumPy)
import scipy.integrate as integrate #scientific computing (SciPy)
...
print("Number of Cores Available: ", multiprocessing.cpu_count()) #Prints the number of CPU cores available for multiprocessing
